...
public class SandboxConjuntos
{
    ...
    {
        return arbolCadenas.descendingSet().stream().collect(Collectors.toList());
    }
    ...
    {
    	NavigableSet<String> nuevoArbol = arbolCadenas.stream().map(String::toUpperCase)
    ...
    {
    	return Arrays.stream(otroArreglo)
                .allMatch(arbolCadenas::contains);
    }
